  ...
  return (
    ...
    <div className='terms-container'>
      ...
      <p>
        ...
        information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the TermsFeed Privacy 
        Policy Generator.
      </p>
      <h2>
      ...
      <p>-Affiliate: means an entity that controls, is controlled by or is under common control with a party, where "control" means 
      ...
      <p>-Company: (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to gowboost.</p>
      <p>-Cookies: are small files that are placed on Your computer, mobile device or any other device by a website, containing the details 
      ...
      <p>-Service Provider: means any natural or legal person who processes the data on behalf of the Company. It refers to third-party 
      ...
      <p>
      -Website: refers to gowboost, accessible from gowboost.com
      </p>
      <p>
        ...
        isaccessing or using the Service, as applicable.
      </p>
      <h2>
      ...
      referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited 
      those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section 
      ...
      of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services 
      ...
      details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You 
      ...
      <a href='mailto:mhamadssafeih@gmail.com'>
        email@gmail.com
      </a>
      <a>
        Join Discord
